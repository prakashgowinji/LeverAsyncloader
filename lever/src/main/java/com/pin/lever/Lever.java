...
import static com.pin.lever.Action.RequestWeakReference;
import static com.pin.lever.Dispatcher.HUNTER_BATCH_COMPLETE;
import static com.pin.lever.Dispatcher.REQUEST_BATCH_RESUME;
import static com.pin.lever.Dispatcher.REQUEST_GCED;
...
import static com.pin.lever.Utils.THREAD_LEAK_CLEANING_MS;
import static com.pin.lever.Utils.THREAD_PREFIX;
import static com.pin.lever.Utils.VERB_CANCELED;
import static com.pin.lever.Utils.VERB_COMPLETED;
import static com.pin.lever.Utils.VERB_ERRORED;
import static com.pin.lever.Utils.VERB_RESUMED;
...
public class Lever {
    ...
    public interface Listener {
         ...
         */
        void onImageLoadFailed(Lever lever, Uri uri, Exception exception);
    }
        ...
        @Override public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case REQUEST_GCED: {
                    ...
                    if (action.getLever().loggingEnabled) {
    ...
    @SuppressLint("StaticFieldLeak") static volatile Lever singleton = null;
    ...
    Lever(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
     ...
     * be used for debugging Lever behavior. Do NOT pass {@code BuildConfig.DEBUG}.
     */
    ...
    /**
     * The global {@link Lever} instance.
     * <p>
     ...
     * with full control over the configuration by using {@link Lever.Builder} to create a
    ...
    public static Lever instance() {
        if (singleton == null) {
            synchronized (Lever.class) {
                if (singleton == null) {
                    if (LeverProvider.context == null) {
                        throw new IllegalStateException("context == null");
                    }
                    singleton = new Builder(LeverProvider.context).build();
                }
            }
        }
        return singleton;
    ...
    /** Fluent API for creating {@link Lever} instances. */
    @SuppressWarnings("UnusedDeclaration") // Public API.
    public static class Builder {
        ...
        /** Start building a new {@link Lever} instance. */
         ...
         * <p>
         * Note: Calling {@link Lever#shutdown() shutdown()} will not shutdown supplied executors.
         */
        ...
        /** Create the {@link Lever} instance. */
        public Lever build() {
            ...
            if (service == null) {
                service = new LeverExecutorService();
            }
            if (transformer == null) {
            ...
            return new Lever(context, dispatcher, cache, listener, transformer, requestHandlers, stats,
