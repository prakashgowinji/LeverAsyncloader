...
final class LeverDrawable extends BitmapDrawable {
    ...
    static void setBitmap(ImageView target, Context context, Bitmap bitmap,
                          Lever.LoadedFrom loadedFrom, boolean noFade, boolean debugging) {
        Drawable placeholder = target.getDrawable();
        if (placeholder instanceof Animatable) {
            ((Animatable) placeholder).stop();
        }
        LeverDrawable drawable =
                new LeverDrawable(context, bitmap, placeholder, loadedFrom, noFade, debugging);
    ...
    LeverDrawable(Context context, Bitmap bitmap, Drawable placeholder,
                  Lever.LoadedFrom loadedFrom, boolean noFade, boolean debugging) {
