...
final class Utils {
    static final String TAG = "QQQ Utils";
    static final String THREAD_PREFIX = "Lever-";
    static final String THREAD_IDLE_NAME = THREAD_PREFIX + "Idle";
    private static final String LEVER_CACHE = "lever-cache";
    ...
    */
    ...
    static File createDefaultCacheDir(Context context) {
        File cache = new File(context.getApplicationContext().getCacheDir(), LEVER_CACHE);
        if (!cache.exists()) {
    ...
    static class LeverThreadFactory implements ThreadFactory {
        @SuppressWarnings("NullableProblems")
        public Thread newThread(Runnable r) {
            return new LeverThread(r);
        }
    }

    private static class LeverThread extends Thread {
        LeverThread(Runnable r) {
            super(r);
        }
